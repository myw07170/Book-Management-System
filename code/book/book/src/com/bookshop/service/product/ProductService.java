...
public class ProductService
{
    ...
    public ProductDetail covertProductRecord(ProductRecord record)
    {
        ...
        detail.setCreateTime(TimeUtils.formate(record.getCreateTime(),
        ...
        detail.setPublicationTime(TimeUtils.formate(record.getPublicationTime(),
    ...
    public List<ProductCommentDetail> getProductCommentByProductId(String productId)
    {
        ...
        List<ProductCommentRecord> listRecord = session.selectList("productCommentManageMapper.queryByProductId", recordFilter);
        ...
        for (ProductCommentRecord record : listRecord)
        {
            ...
            detail.setCommentTime(TimeUtils.formate(record.getCommentTime(),
                ConstantCode.TIME_FORMAT_YYYYMMDDHHMMSS,
                ConstantCode.TIME_FORMAT_YYYY_MM_DD_HH_MM_SS));
