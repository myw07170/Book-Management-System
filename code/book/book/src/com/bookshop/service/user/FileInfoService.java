...
public class FileInfoService
{
    public static final Pattern IMAGE_PATTERN =
        Pattern.compile("<img\\s+(?:[^>]*)src\\s*=\\s*([^>]+)", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE);
    ...
    public List<FileInfoRecord> getFileInfoListByObjectId(String objectId)
    {
        ...
        return org.springframework.util.CollectionUtils.isEmpty(resultList) ? new ArrayList<FileInfoRecord>() : resultList;
    }
}
