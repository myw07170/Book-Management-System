...
public class BackstageController
{
    ...
    public ModelAndView login(HttpServletRequest request, ModelAndView model)
    {
    		...
    		//刷新登陆时间
    		String currentTime1 = TimeUtils.getUTCCurrentTime(TimeUtils.getUTCCurrentTime(ConstantCode.TIME_FORMAT_YYYY_MM_DD_HH_MM_SS));
    		//日志输出
    ...
    public ModelAndView modifyUser(HttpServletRequest submitForm, ModelAndView model)
    {
        ...
        recordCheck.setBirthday(TimeUtils.formate(birthday,
    ...
    public ModelAndView addNormalUser(HttpServletRequest submitForm, ModelAndView model)
    {
        ...
        record.setSex(sex);
        record.setBirthday(TimeUtils.formate(birthday,
            ConstantCode.TIME_FORMAT_YYYY_MM_DD,
            ConstantCode.TIME_FORMAT_YYYYMMDD));
