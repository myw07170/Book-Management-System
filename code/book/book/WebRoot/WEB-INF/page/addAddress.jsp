                    ...
                    <div id="slider">
                        <div class="col span_2_of_3">
                            <div class="form-userinfo">
                                ...
                                <form id="submitForm" name="submitForm" method="post" action="<%=basePath%>/addAddress?username=${username}"
                                onsubmit="return submitCheck();">
                                    <div>
                                        ...
                                        <span>
                                            <input id="defaultAddress1" name="defaultAddressR" type="radio" class="textbox" value="1" checked="checked"/>是
                                            <input id="defaultAddress2" name="defaultAddressR" type="radio" class="textbox" value="0"/>否
                                            <input id="defaultAddress" name="defaultAddress" type="hidden" value="1"/>
                                        </span>
                                    </div>                                
                                    <div>
                                        <span>
